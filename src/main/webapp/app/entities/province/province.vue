<template>
  <div>
    <h2 id="page-heading" data-cy="ProvinceHeading">
      <span v-text="t$('mobilePosApp.province.home.title')" id="province-heading"></span>
      <div class="d-flex justify-content-end">
        <button class="btn btn-info mr-2" v-on:click="handleSyncList" :disabled="isFetching">
          <font-awesome-icon icon="sync" :spin="isFetching"></font-awesome-icon>
          <span v-text="t$('mobilePosApp.province.home.refreshListLabel')"></span>
        </button>
        <router-link :to="{ name: 'ProvinceCreate' }" custom v-slot="{ navigate }">
          ...
          >
            ...
            <span v-text="t$('mobilePosApp.province.home.createLabel')"></span>
          </button>
        </router-link>
      </div>
    </h2>
    ...
    <div class="alert alert-warning" v-if="!isFetching && provinces && provinces.length === 0">
      <span v-text="t$('mobilePosApp.province.home.notFound')"></span>
    </div>
        ...
        <thead>
          <tr>
            ...
            <th scope="row" v-on:click="changeOrder('name')">
              <span v-text="t$('mobilePosApp.province.name')"></span>
              <jhi-sort-indicator :current-order="propOrder" :reverse="reverse" :field-name="'name'"></jhi-sort-indicator>
            </th>
            <th scope="row" v-on:click="changeOrder('country.isoCode')">
              <span v-text="t$('mobilePosApp.province.country')"></span>
              <jhi-sort-indicator :current-order="propOrder" :reverse="reverse" :field-name="'country.isoCode'"></jhi-sort-indicator>
            </th>
            <th scope="row"></th>
          </tr>
        </thead>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <template #modal-title>
        <span id="mobilePosApp.province.delete.question" data-cy="provinceDeleteDialogHeading" v-text="t$('entity.delete.title')"></span>
      </template>
      <div class="modal-body">
        <p id="jhi-delete-province-heading" v-text="t$('mobilePosApp.province.delete.question', { id: removeId })"></p>
      </div>
