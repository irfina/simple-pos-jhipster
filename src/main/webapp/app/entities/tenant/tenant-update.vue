  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" novalidate v-on:submit.prevent="save()">
        <h2
          id="mobilePosApp.tenant.home.createOrEditLabel"
          data-cy="TenantCreateUpdateHeading"
          v-text="t$('mobilePosApp.tenant.home.createOrEditLabel')"
        ></h2>
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('mobilePosApp.tenant.name')" for="tenant-name"></label>
            <input
              type="text"
              class="form-control"
              name="name"
