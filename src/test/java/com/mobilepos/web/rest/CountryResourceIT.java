...
import static com.mobilepos.domain.CountryAsserts.*;
...
class CountryResourceIT {
    ...
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{isoCode}";
    ...
    public static Country createEntity(EntityManager em) {
        Country country = new Country().isoCode(UUID.randomUUID().toString()).name(DEFAULT_NAME);
        return country;
    }
    ...
    public static Country createUpdatedEntity(EntityManager em) {
        Country country = new Country().isoCode(UUID.randomUUID().toString()).name(UPDATED_NAME);
        return country;
    }
    ...
    void getAllCountries() throws Exception {
        ...
        restCountryMockMvc
            .perform(get(ENTITY_API_URL + "?sort=isoCode,desc"))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.[*].isoCode").value(hasItem(country.getIsoCode())))
    ...
    void getCountry() throws Exception {
        ...
        // Get the country
        restCountryMockMvc
            .perform(get(ENTITY_API_URL_ID, country.getIsoCode()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.isoCode").value(country.getIsoCode()))
    ...
    void putExistingCountry() throws Exception {
        ...
        // Update the country
        Country updatedCountry = countryRepository.findById(country.getIsoCode()).orElseThrow();
        ...
        restCountryMockMvc
            .perform(
                put(ENTITY_API_URL_ID, countryDTO.getIsoCode())
    ...
    void partialUpdateCountryWithPatch() throws Exception {
        ...
        partialUpdatedCountry.setIsoCode(country.getIsoCode());

        partialUpdatedCountry.name(UPDATED_NAME);

        restCountryMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, partialUpdatedCountry.getIsoCode())
    ...
    void patchNonExistingCountry() throws Exception {
        ...
        restCountryMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, countryDTO.getIsoCode())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(countryDTO))
            )
            .andExpect(status().isBadRequest());
    ...
    void deleteCountry() throws Exception {
        ...
        // Delete the country
        restCountryMockMvc
            .perform(delete(ENTITY_API_URL_ID, country.getIsoCode()).accept(MediaType.APPLICATION_JSON))
    ...
    protected Country getPersistedCountry(Country country) {
        return countryRepository.findById(country.getIsoCode()).orElseThrow();
    }
