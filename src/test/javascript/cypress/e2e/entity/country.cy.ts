...
describe('Country e2e test', () => {
  ...
  const countrySample = { isoCode: 'ecfc7', name: 'raise rightfully instead' };
  ...
  describe('new Country page', () => {
    ...
    it('should create an instance of Country', () => {
      cy.get(`[data-cy="isoCode"]`).type('d219e');
      cy.get(`[data-cy="isoCode"]`).should('have.value', 'd219e');

      cy.get(`[data-cy="name"]`).type('huzzah');
      cy.get(`[data-cy="name"]`).should('have.value', 'huzzah');
